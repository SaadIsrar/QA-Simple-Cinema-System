 ...
 */
public class Oap extends Ticket {        // public class presents members class as public such as Oap.
    Oap(int amount, boolean discount){     // Oap refer as an object, int variables represents as integar which is a variable,boolean performs logical operations such as true or false.
